...
-- Dumping data for table balines-mojados.reserves: ~6 rows (approximately)
REPLACE INTO `reserves` (`Id`, `user`, `room`, `plan`, `date`, `time`, `players`, `phone`, `name`, `lastname`) VALUES
	(1, 3, 1, 1, '2024-08-28', '10:00:00', 5, 1, 'a', 'b'),
	(2, 3, 2, 4, '2024-08-28', '10:00:00', 5, 1, 'a', 'b'),
	(3, 3, 3, 2, '2024-08-28', '10:00:00', 5, 1, 'a', 'b'),
	(4, 3, 4, 4, '2024-08-28', '10:00:00', 5, 1, 'a', 'b'),
	(5, 3, 5, 1, '2024-08-28', '10:00:00', 5, 1, 'a', 'b'),
	(6, 3, 6, 3, '2024-08-28', '10:00:00', 5, 1, 'a', '');
...
-- Dumping data for table balines-mojados.sessions: ~3 rows (approximately)
...
-- Dumping data for table balines-mojados.users: ~3 rows (approximately)
