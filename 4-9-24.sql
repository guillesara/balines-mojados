...
-- Volcando datos para la tabla balines-mojados.reserves: ~5 rows (aproximadamente)
REPLACE INTO `reserves` (`id`, `payment_id`, `user`, `room`, `plan`, `date`, `time`, `players`, `name`, `lastname`, `phone`) VALUES
	...
	(2, 1319450064, 3, 1, 4, '2024-09-04', '11:00:00', 10, 'juan', 'pene', 132456789),
	(3, 1326575449, 3, 1, 4, '2024-09-04', '16:00:00', 10, 'juan', 'pene', 132465789),
	(4, 1319450110, 3, 1, 4, '2024-09-04', '15:00:00', 1, 'asd', 'asd', 1234),
	(5, 1319450152, 7, 1, 4, '2024-09-04', '16:00:00', 10, 'asd', 'asd', 123);
...
-- Volcando datos para la tabla balines-mojados.sessions: ~5 rows (aproximadamente)
REPLACE INTO `sessions` (`id`, `userId`, `device`, `application`, `ip`, `logged`) VALUES
	...
	(13, 2, 'Microsoft Windows', 'Chrome', '127.0.0.1', '2024-09-04 20:09:18');
...
REPLACE INTO `users` (`id`, `group`, `mail`, `username`, `password`) VALUES
	...
	(7, 'user', 'guillermosaraciniet32@gmail.com', 'guille', '$2b$10$32ui/g16cGHHOI3LbpaWTe.CDOwkNiapn/gMFN5HTjMakk9na8upC');
